...
public static void main(String[] args) throws Throwable {
	...
	driver.findElement(By.xpath("//td[@style='padding-right:0px;padding-left:10px;']//a//img[@title='Create Product...']")).click();
    driver.findElement(By.xpath("//input[@name='productname']")).sendKeys(cellsheet);
	...
	{
		System.out.println("Created Prod_info is sucussfully");
	}else {
		System.out.println("Created Prod_info is unsucussfully");
	}
	
	driver.findElement(By.xpath("//input[@title='Delete [Alt+D]']")).click();
	Alert al = driver.switchTo().alert();
	al.accept();
    System.out.println("Product is delete sucussfully");
